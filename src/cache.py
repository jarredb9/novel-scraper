"""Caching manager for the web novel scraper.

This module provides caching functionality to save scraped HTML chapters to
the local filesystem and retrieve them to enable resume-friendly behavior.
"""
...
class CachingManager:
    """Manages local HTML caching for the novel scraper.

    Supports resume-friendly behavior by saving and reading HTML content.
    """

    def __init__(self, cache_dir: str = "./cache"):
        """Initializes the caching manager and ensures directory exists.
    ...
    def read_chapter(self, chapter_num: int) -> Optional[str]:
        ...
        Returns:
            Optional[str]: HTML content if cached, or None if not.
        """
